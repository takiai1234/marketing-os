...
export const config = {
  matcher: [
    '/((?!api/auth|api/skills/upload|api/news/ingest-ads|api/news/ingest-web|api/admin/run-job|api/telegram/webhook|api/analytics/overview|_next|favicon.ico|public|login).*)',
  ],
};
