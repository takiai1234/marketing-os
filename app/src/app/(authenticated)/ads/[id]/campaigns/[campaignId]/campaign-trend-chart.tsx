...
// Trend chart 30 ngày cho 1 campaign — line chart với 3 toggle metric:
// Spend / Impressions / Conversions. Reuse pattern AdsTrendChart account-level.
...
// Inline micros→display để tránh client-bundle import server lib
...
export function CampaignTrendChart({ data, currency }: Props) {
    ...
    return (
      <div className="rounded-xl bg-white ring-1 ring-zinc-200 shadow-sm p-6">
        ...
        <p className="text-xs text-zinc-500 italic py-6 text-center">
          Chưa có data — sync ad account để pull insights cho campaign này.
        </p>
      </div>
    );
  }
